...
function DeliveryResDetails() {
  ...
  return (
    ...
    <div className="w-[1100px] mx-auto">
      <div className="flex flex-col gap-2 text-start">
        ...
        <div className="flex gap-1 my-4 transition-all duration-300">
          ...
          <Link to={"/Ahmedabad/order-food-online"}>
            <p className="hover:text-red-500 text-gray-600">
        ...
        <div className="w-full h-[370px] overflow-hidden">
          <div
            className="w-full h-full hover:scale-110 transition-all duration-500  bg-no-repeat bg-cover rounded-lg bg-center"
        ...
        <div>
          <div className="flex justify-between mt-2">
            ...
            <div className="flex gap-8  justify-center items-center">
              <div>
                <p className=" flex gap-1 items-center bg-green-800 text-lg text-white w-max px-2 py-[1px] rounded-lg">
                  {Restaurants.Delivery_Reviews}{" "}
          ...
          <p className=" text-lg mt-1">
            <span className=" text-red-500">Opening Time -</span>{" "}
            {Restaurants.openTime} - {Restaurants.CloseTime} (Today)
          </p>
      ...
      {/* foods  */}
      <div className=" ">
        <h1 className=" text-start my-4 text-red-600 font-semibold text-3xl">
          Order Online
        </h1>
        {Restaurants.Foods ? (
              ...
              <div className=" w-[130px] h-[130px]">
                ...
                <div className=" mt-2 ">
                  {CartData.some((CartItem) => CartItem.id === item.id) ? (
                    <button
                      className=" py-3 px-3 bg-red-500 text-white text-xs font-semibold rounded-xl"
                      onClick={() => RemoveToCartBtn(item.id)}
                    >
                      Remove To Cart
                    </button>
                  ) : (
                    <button
                      className="py-3 px-6 bg-slate-800 text-white text-xs font-semibold rounded-xl"
