    ...
    <>
      <Link to={`/Ahmedabad/order-food-online/${title}/order`}>
        <div className="hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] rounded-xl border border-gray-100  mb-4  ">
          ...
          >
            {data.discount && (
              <div className=" absolute bg-blue-600 px-2  bottom-[20px] text-white">
                {data.discount} %OFF
              </div>
            )}
            <div className="absolute bottom-[-64px] px-2">
              <div className="flex justify-between">
                ...
                <p className=" bg-green-700 px-2 rounded-lg text-white py-[1px] flex items-center gap-1">
              ...
              <div className="flex gap-24 mt-1  w-[248]">
                <p>
                  {data.dishes.lenght < 30
                    ? data.dishes
                    : `${data.dishes.substring(0, 20)}...`}
                </p>
