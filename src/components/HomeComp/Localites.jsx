...
import {
  AddLocalities,
  AllAddLocalities,
} from "../../features/Slices/LocalitiesSlice";
...
function Localites() {
  ...
  return (
    <div className=" w-[1100px] mx-auto mt-[4rem] ">
      <div className=" text-start text-4xl text-gray-800">
      ...
      {localities.length > 0 ? (
        <div className="flex flex-wrap gap-3 mt-8">
          ...
          <div>
            {!showMore && (
              <div
                className="flex gap-2 border py-7 px-[125px] rounded-md justify-center items-center cursor-pointer"
            ...
            {showMore && (
              ...
              >
                <p className="text-xl text-gray-800">ShowLess</p>
