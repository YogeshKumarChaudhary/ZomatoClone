...
import {
  AddAllCollection,
  AddCollection,
} from "../../../features/Slices/CollectionSlice";
    ...
    <div className="w-[1100px] mx-auto mt-10">
      <div>
        ...
        <div className="flex items-center justify-between mb-7 mt-2">
          <p className="text-start text-xl font-light   text-black ">
            Explore curated lists of top restaurants, cafes, pubs, and bars in
            Ahmedabad, based on trends{" "}
          </p>
          {!showCollection && (
            <span
              className=" text-red-500 text-lg font-normal  flex items-center cursor-pointer"
              onClick={AllCollectionRender}
            >
