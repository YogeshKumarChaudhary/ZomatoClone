...
function DeliveryAndDiningHeader() {
  ...
  useEffect(() => {
    if (type == "dine-out") setDineOut(true);
    else setDilivery(true);
  }, [location.pathname]);
          ...
          <div className="flex flex-col gap-2 items-center justify-center">
            <div className="flex gap-2 items-center justify-center">
              ...
              <div>
                <h1
                  className={`(${
                    isDelivery ? " text-red-400" : "text-gray-600"
          ...
          <div className="flex gap-2 flex-col">
            <div className="flex gap-2 items-center justify-center">
              ...
              <div>
                <h1
                  className={`${
                    isDineOut ? " text-red-400" : "text-gray-600"
                  } font-semibold  text-xl`}
                >
                  Dining Out
                </h1>
            ...
            {isDineOut && <div className=" border-2 border-red-400 mt-3"></div>}
          </div>
        </Link>
      </div>
    </div>
