      ...
      <div>
        {!isuser && (
          <div className="flex gap-5">
            ...
            <div
              className=" cursor-pointer"
              onClick={() => setShowSingupModal(true)}
            >
              Sign up
            </div>
          </div>
        ...
        {isuser && (
          <div className="flex items-center gap-3 relative bottom-2">
            <p className="border-2 cursor-pointer rounded-full text-5xl text-blue-50">
              <FaUserCircle />
            </p>
            <p
              className="  font-semibold border pt-1 pb-2 px-2 rounded-lg cursor-pointer"
              onClick={() => {
                setIsuser(false);
