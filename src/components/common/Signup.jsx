...
function Signup({ setSignupModal, setIsuser }) {
  ...
  function SingupInfoHandler(event) {
    setSignupInfo((prev) => {
  ...
  function submitbtnhandler(event) {
    ...
    if (SignupInfo.fullname.length > 5 && SignupInfo.email.length > 8) {
      toast.success("Account Created successfully");
      setSignupModal(false);
      setIsuser(true);
      console.log(SignupInfo);
    } else {
      toast.error("Enter valid email and fullname");
      setSignupInfo({
        fullname: "",
        email: "",
      });
  ...
  return (
    <div>
      <div
        id="YOUR_ID"
        className="fixed z-50 inset-0 overflow-y-auto w-[450px] mx-auto"
      >
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            <div className="flex justify-between text-black ">
              ...
              <button
                onClick={() =>
                  setSignupModal ? setSignupModal(false) : navigate("/")
                }
                type="button"
            ...
            <div className=" text-black">
              <div className=" flex mt-8 mb-4  border-2 rounded-lg px-3 gap-2 text-black text-base  items-center ">
                <input
                  className=" w-full border-none placeholder:text-lg outline-none  py-3"
                  type="text"
                  name="fullname"
                  value={SignupInfo.fullname}
                  onChange={SingupInfoHandler}
                  id=""
                  placeholder="Full Name"
                />
              </div>
              <div className=" flex mt-5 mb-4  border-2 rounded-lg px-3 gap-2 text-black text-base  items-center ">
                <input
                  className=" w-full border-none placeholder:text-lg outline-none  py-3"
                  type="email"
                  name="email"
              ...
              <div className="flex gap-1  items-start my-5">
                ...
                <p className=" text-sm">
                  ...
                  and <span className=" text-red-500">Content Policies</span>{" "}
                </p>
              </div>
              <div className=" bg-red-500 text-white hover:bg-red-600 w-full py-2 px-3 text-center text-lg rounded-md">
              ...
              <div className=" my-5 w-full flex py-2 px-2 items-center border-2 rounded-lg justify-center gap-4">
                <p className=" pl-4 text-3xl text-red-500">
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 22 22"
                ...
                <p className=" text-gray-800 text-lg">Continue With Google</p>
              </div>
