        ...
        <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
          ...
          >
            <div className="flex justify-between text-black ">
              ...
              <button
                onClick={() =>
                  setloginModal ? setloginModal(false) : navigate("/")
                }
                type="button"
            ...
            <div className=" text-black">
              <div className=" flex mt-8 mb-4  border-2 rounded-lg px-3 gap-2 text-black text-base  items-center ">
                <span className=" w-8">
                  <img src="https://b.zmtcdn.com/images/flags_z10/in.png?output-format=webp"></img>
                </span>
                +91
                <input
              ...
              <div className=" my-2 w-full flex py-2 px-2 items-center border-2 rounded-lg justify-center gap-4">
                ...
                <p className=" text-gray-800 text-lg">Continue With Email</p>
              </div>
              ...
              <div className=" flex  text-lg gap-2">
                <p className=" text-gray-800">New to Zomato?</p>
                <p
